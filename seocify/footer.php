            ...
            <div class="col-md-4">
                <?php  if (!empty($footer_logo)) { ?>
                    <div class="footer-logo">
                        ...
                        <?php 
                            echo wp_get_attachment_image( attachment_url_to_postid($footer_logo), 'full', "", array( 
                                "alt" => esc_attr('Footer Logo') 
                            ));  
                        ?>
                        </a>
                    </div>
                ...
                <ul class="address-info-list list-inline">
                    <li>
                        <?php  if (!empty($footer_map_pin_img)) { ?>
                            ...
                            <?php 
                                echo wp_get_attachment_image( attachment_url_to_postid($footer_map_pin_img), 'full', "", array( 
                                    "alt" => esc_attr('footer address'),
                                ));  
                            ?>
                            </div>
                        <?php } ?>
                    ...
                    <li>
                        <?php  if (!empty($footer_contact_img)) { ?>
                            <div class="address-icon">
                                <?php 
                                    echo wp_get_attachment_image( attachment_url_to_postid($footer_contact_img), 'full', "", array( 
                                        "alt" => esc_attr('footer contanct'),
                                    ));  
                                ?>
                            </div>
                        <?php } ?>
                                ...
                                <?php if (is_array($partner_logo) && !empty($partner_logo)): ?>
                                    <?php foreach ($partner_logo as $index => $item):
                                        ...
                                        if (!empty($item['image'])) {
                                            ...
                                            $img = wp_get_attachment_image( $item['image'], 'full', "", array( 
                                                "alt" => seocify_get_alt_name($item),
                                            )); 
                                            echo '<li>'.$lin_start. $img .$link_end.'</li>';
                                        }
                                        ?>
                                    <?php endforeach; ?>
                                <?php endif; ?>
