...
function seocify_customizer_sections($wp_customize){
    ...
    $wp_customize->add_section( 'optimization_section', array(
        'title'			=> esc_html__( 'Optimization Settings', 'seocify' ),
        'priority'		=> 8,
        'description'	=> esc_html__( 'Setting Your Optimization Options', 'seocify' ),
        'panel'          => 'theme_option',
    ) );
}
