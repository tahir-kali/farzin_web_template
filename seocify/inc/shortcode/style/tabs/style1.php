            ...
            <a class="nav-link <?php echo esc_attr($active) ?>" data-toggle="tab"
               href="#<?php echo esc_attr($id_int . '-' . $key); ?>">
                <?php if (!empty($item['title_image']['url'])): ?>
                    <p>
                        <?php 
                            echo wp_get_attachment_image( $item['title_image']['id'], 'full',"",array(
                                'alt'  =>  get_the_title($item['title_image']['id']),
                            ));
                        ?>
                    </p>
                <?php endif; ?>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6">
                            <div class="service-preview-img">
                                <?php
                                    echo wp_get_attachment_image( $item['content_image']['id'], 'full',"",array(
                                        'alt'  =>  get_the_title($item['content_image']['id']),
                                    ));
                                ?>
