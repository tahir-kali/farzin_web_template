    ...
    protected function render( ) {
        ...
        if($xs_query->have_posts()):
            if($filter == 'yes'){ $carousel='no';?>
                ...
                <?php if($carousel == 'yes'){ ?>
                    <div class="case-study-slider swiper" data-column="<?php echo esc_attr($count_col); ?>" data-nav="<?php echo esc_attr($seocify_style_case_carousel_nav); ?>" data-dot="<?php echo esc_attr($seocify_style_case_carousel_dot); ?>">
            ...
            <?php }else{ ?>
                <?php if($carousel == 'yes'){ ?>
                    <div class="case-study-slider swiper <?php echo esc_attr( $style == 'style3' ? 'case_study_3' : ''); ?>" data-column="<?php echo esc_attr($count_col); ?>" data-nav="<?php echo esc_attr($seocify_style_case_carousel_nav); ?>" data-dot="<?php echo esc_attr($seocify_style_case_carousel_dot); ?>">
                    <div class="swiper-wrapper">
                <?php }else{
            ...
            <!-- slider controls -->
            <?php if($seocify_style_case_carousel_dot == "yes"){ ?>
            <div class="case-study-pagination"></div>
            <?php } ?>
            <?php if($seocify_style_case_carousel_nav == "yes"){ ?>
            <div class="case-study-navigation"></div>
            <?php } ?>
            <!-- slider control end -->
            </div>
        <?php
