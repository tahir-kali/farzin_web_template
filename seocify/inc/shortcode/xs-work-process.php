...
class XS_Work_Process_Widget extends Widget_Base {
    ...
    protected function register_controls() {
		...
		$this->add_control(
			'work_process_items',
			[
				'label' => __( 'Work Process Items', 'seocify' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
                        'title' => esc_html__('Planning','seocify'),
                        'description' => esc_html__('Description','seocify'),
                        'socify_work_process_yes' => esc_html__( '2021', 'seocify' )
                    ]
				],
				'title_field' => '{{{ title }}}',
			]
    ...
    protected function render( ) {
        ...
        $widgets_controls = \json_encode($widgets_controls);
