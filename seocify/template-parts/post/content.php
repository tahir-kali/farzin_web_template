	...
	<div <?php post_class( 'post-list ' ); ?>>
				...
				<div class="post-image">
					<div class="gallery-slider owl-carousel">
						...
						foreach ( $gallery_images as $gallery_image ) {
							...
							<?php
								echo wp_get_attachment_image( attachment_url_to_postid($gallery_image[ 'url' ]), 'full', "", array( 
									"alt" => esc_attr('blog list image'),
								));  
							?>
							</div>
							<?php
		...
		<div class="post-body">
			<div class="entry-header">
				...
				<?php
				if ( is_sticky() ) {
					echo '<span class="meta-featured-post sticky"> <i class="xsicon xsicon-thumbtack"></i> ' . esc_html__( 'Featured', 'seocify' ) . ' </span>';
				}
				?>
